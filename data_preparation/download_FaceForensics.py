...
#                 'NeuralTextures']
ALL_DATASETS = ['original', 'Deepfakes', 'Face2Face',
                'FaceShifter', 'FaceSwap', 'NeuralTextures']
DEEPFEAKES_DETECTION_DATASET = ['DeepFakeDetection_original', 'DeepFakeDetection']
...
def parse_args():
    ...
    parser.add_argument('-d', '--dataset', nargs='+', default='all',
    ...
    parser.add_argument('-n', '--num_videos', type=int, default=None,
                        help='Select a number of videos number to '
                             ...
                             ' dataset.')
    parser.add_argument('-s', '--server', type=str, default='EU2',
...
def main(args):
    ...
    # Extract arguments
    # c_datasets = args.dataset if 'all' not in args.dataset else ALL_DATASETS
    if 'all' in args.dataset:
        c_datasets = ALL_DATASETS
    elif "deepfake_detection" in args.dataset:
        c_datasets = DEEPFEAKES_DETECTION_DATASET
    else:
        c_datasets = args.dataset
